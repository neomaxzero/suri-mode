...
- When resuming prior work or answering where it stands, follow [resume context](references/resume-context.md): use available summaries and existing task records first, then investigate only material gaps.
